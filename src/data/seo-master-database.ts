...
export const masterKeywordDatabase: MasterKeywordRecord[] = [
  ...
  },
  {
    ...
    funnelStage: "Top (Awareness)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/riverside",
  ...
  },
  {
    ...
    landingPageUrl: "/mantra-meridian-riverside/rera",
  ...
  },
  {
    ...
    funnelStage: "Middle (Evaluation)",
    priority: "Tier B (Commercial)",
    landingPageUrl: "/mantra-meridian-riverside/gallery",
  ...
  },
  {
    ...
    funnelStage: "Top (Awareness)",
    priority: "Tier B (Commercial)",
    landingPageUrl: "/mantra-meridian-riverside/residences",
  ...
  // 04. CONFIGURATION (2, 3, 4 BHK & DUPLEX)
  {
    ...
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/2-bhk",
  ...
  },
  {
    ...
    funnelStage: "Bottom (Conversion)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/3-bhk",
  ...
  },
  {
    ...
    funnelStage: "Bottom (Conversion)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/3-bhk-duplex",
  ...
  },
  {
    ...
    funnelStage: "Bottom (Conversion)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/4-bhk",
  ...
  // 05. PRICE / COST / COMMERCIAL
  {
    ...
    funnelStage: "Bottom (Conversion)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/price",
  ...
  // 06. FLOOR PLANS & BLUEPRINTS
  {
    ...
    funnelStage: "Middle (Evaluation)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/floor-plans",
    primaryH1: "Designed for Elegance, Built for Comfort",
  ...
  // 07. AMENITIES & LIFESTYLE
  {
    ...
    funnelStage: "Middle (Evaluation)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/amenities",
  ...
  // 09. CONNECTIVITY & TRANSIT
  {
    ...
    funnelStage: "Middle (Evaluation)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/location",
  ...
  },
  {
    ...
    funnelStage: "Bottom (Conversion)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/documents",
  ...
  // 13. COMPETITOR & LOCALITY COMPARISONS
  {
    ...
    landingPageUrl: "/mantra-meridian-riverside/journal/balewadi-vs-baner-real-estate-comparison/",
  ...
  },
  {
    ...
    funnelStage: "Middle (Evaluation)",
    priority: "Tier C (Authority)",
    landingPageUrl: "/mantra-meridian-riverside/journal/hinjewadi-balewadi-connectivity-corridor/",
  ...
  {
    keyword: "Hinjewadi IT Park executive flats Balewadi",
    universe: "13. Competitor & Locality Comparisons",
    intent: "Commercial",
    funnelStage: "Middle (Evaluation)",
    priority: "Tier B (Commercial)",
    landingPageUrl: "/mantra-meridian-riverside/journal/hinjewadi-it-corridor-balewadi-luxury-housing-guide/",
    primaryH1: "The Hinjewadi IT Park Executive Housing Guide",
    recommendedTitleTag: "Hinjewadi IT Park Housing Guide | Tech Executives Choose Balewadi",
    schemaType: "Article",
    conversionCta: "EXPLORE IT EXECUTIVE RESIDENCES"
  },
  {
    keyword: "Baner vs Balewadi vs Mahalunge real estate",
    universe: "13. Competitor & Locality Comparisons",
    intent: "Informational",
    funnelStage: "Middle (Evaluation)",
    priority: "Tier B (Commercial)",
    landingPageUrl: "/mantra-meridian-riverside/journal/baner-vs-balewadi-vs-mahalunge-real-estate-investment-2026/",
    primaryH1: "Baner vs Balewadi vs Mahalunge: 2026 Investment Thesis",
    recommendedTitleTag: "Baner vs Balewadi vs Mahalunge Real Estate Investment 2026",
    schemaType: "Article",
    conversionCta: "READ INVESTMENT THESIS"
  },
  {
    keyword: "Sky Duplex vs Penthouse Pune",
    universe: "08. Luxury / Architectural Heritage",
    intent: "Informational",
    funnelStage: "Middle (Evaluation)",
    priority: "Tier B (Commercial)",
    landingPageUrl: "/mantra-meridian-riverside/journal/sky-duplex-vs-penthouse-luxury-living-pune/",
    primaryH1: "Sky Duplex vs Conventional Penthouse Architecture",
    recommendedTitleTag: "Sky Duplex vs Penthouse Pune | Vertical Luxury Living",
    schemaType: "Article",
    conversionCta: "EXPLORE SKY DUPLEX BLUEPRINTS"
  },
  {
    keyword: "Mantra Meridian vs Kumar Magnacity",
    universe: "13. Competitor & Locality Comparisons",
    intent: "Commercial",
    funnelStage: "Middle (Evaluation)",
    priority: "Tier B (Commercial)",
    landingPageUrl: "/mantra-meridian-riverside/journal/kumar-magnacity-vs-mantra-meridian-riverside-comparison/",
    primaryH1: "Comparative Analysis: Mantra Meridian vs Competing West Pune Projects",
    recommendedTitleTag: "Mantra Meridian vs Competing Projects | West Pune Comparison",
    schemaType: "Article",
    conversionCta: "COMPARE PROJECT SPECIFICATIONS"
  },
  ...
  // 15. AI, VOICE & CONVERSATIONAL SEARCH
  {
    ...
    funnelStage: "Top (Awareness)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/price#faq",
  ...
  },
  {
    ...
    funnelStage: "Top (Awareness)",
    priority: "Tier A (Immediate)",
    landingPageUrl: "/mantra-meridian-riverside/location#faq",
